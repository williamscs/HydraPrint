...
},{"./templates/job/JobContainer.jsx":6,"./templates/printer/PrinterContainer.jsx":8,"jquery":10,"react":165}],3:[function(require,module,exports){
var React = require('react');
	...
	render: function() {
		...
		return (
			React.createElement("div", {className: "item-cell"}, 
				React.createElement("div", {className: "new-cell"}, 
					React.createElement("img", {src: "./images/plus.png", alt: "MDN"}), 
					React.createElement("br", null), 
					React.createElement("br", null), 
					React.createElement("span", null, "Add new ", this.props.itemType)
				)
			)
		);
	}
		...
		render: function() {
			...
			return (
				React.createElement("div", {className: "progress animate"}, 
					...
					React.createElement("span", {className: "progressBar", style: {width: progress + '%'}}, 
...
module.exports = React.createClass({displayName: "exports",
		render: function() {
			...
			return (
				React.createElement("div", {className: "item-cell", key: this.props.id}, 
					React.createElement("div", {className: "job-cell"}, 
						...
						React.createElement(ProgressBar, {progress: this.props.progress})
					)
				)
		);
	}
});
},{"../ProgressBar.jsx":4,"react":165}],6:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
	render: function() {
						var nodes = this.props.jobs.map(function(job) {
							return (
								React.createElement(JobCell, {key: job.id, title: job.title, printer: job.printer, progress: job.progress})
							);
						});
		...
		return (
			React.createElement("div", {id: "items"}, 
				nodes, 
				React.createElement(NewItem, {itemType: "job"}), 
				React.createElement("div", {className: "contentEndText"}, React.createElement("a", {href: "#"}, "View previous jobs"))
			)
		);
	}
});
},{"../NewItem.jsx":3,"./JobCell.jsx":5,"react":165}],7:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
		render: function() {
			...
			return (
				React.createElement("div", {className: "item-cell"}, 
					React.createElement("img", {className: "printer-image", src: type}, 
						React.createElement("br", null), 
						React.createElement("span", {className: "printer-name"}, this.props.printerName)
					)
				)
		);
	}
...
module.exports = React.createClass({displayName: "exports",
	render: function() {
						var nodes = this.props.printers.map(function(printer) {
							return (
								React.createElement(PrinterCell, {key: printer.id, printerName: printer.name, printerType: printer.type})
							);
						});
		...
		return (
			React.createElement("div", {id: "items"}, 
				nodes, 
				React.createElement(NewItem, {itemType: "printer"})
			)
		);
	}
});
},{"../NewItem.jsx":3,"./PrinterCell.jsx":7,"react":165}],9:[function(require,module,exports){
